...
**kotlin-avito-api** — это современное backend-решение для e-commerce платформы, построенное на Spring Boot и Kotlin. Проект предоставляет полнофункциональный REST API для управления пользователями, товарами, корзинами покупок и заказами с интеллектуальной системой рекомендаций.
